...
function SearchQueue(reqRef, resRef, cleanupInterval) {
   this.inRef = reqRef;
   this.outRef = resRef;
...
exports.init = function(url, reqPath, resPath, matchWholeWords, cleanupInterval) {
   new SearchQueue(fbutil.fbRef(url, reqPath), fbutil.fbRef(url, resPath), matchWholeWords, cleanupInterval);
};
