            ...
            rootRef.createUser({
                ...
                if (error) {
                    switch (error.code) {
                        case "EMAIL_TAKEN":
                            {
                                checkUserRoot(self.userRootRef.child(userId), userId);
                    ...
                    createUserRoot(self.userRootRef.child(userId), userId);
                    console.log("User account " + userId + " created successfully!");
                }
            });
        }
